...
def play_wav_file(wav_file):
    ...
    if not shutil.which("ffplay"):
        print("Warning: ffplay not found. Install ffmpeg to play audio.", file=sys.stderr)
        return False
...
def main():
    parser = argparse.ArgumentParser(description="Generate speech from text using Piper TTS")
